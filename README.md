...
| ✅ Да / Нет | 50 | Одна карта — чёткий ответ на вопрос |
| ⏳ Прошлое — Настоящее — Будущее | 50 | Три карты по оси времени |
| 💕 На отношения | 80 | Расклад на любовь и партнёрство |
| 🧠 Что обо мне думает | 80 | Что чувствует к вам конкретный человек |
| 💰 Карьера и деньги | 80 | Финансы, работа, перспективы |
| 📅 На неделю | 100 | 7 карт — прогноз на каждый день |
| 🗓️ На месяц | 120 | Развёрнутый прогноз на месяц |
| ✝️ Кельтский крест | 200 | Классический полный расклад (10 карт) |
| ❓ Свободный вопрос | 50 | Любой вопрос — карты ответят |

### 🔮 Эзотерические практики

| Практика | Оракулы | Описание |
|----------|---------|----------|
| ♈ Гороскоп | 50 | Персональный гороскоп по знаку зодиака |
| ᚱ Руны | 50 | Рунический расклад с толкованием |
| 💤 Толкование снов | 50 | AI-анализ сновидений |
| 👼 Ангельские числа | 50 | Расшифровка числовых знаков |
| 🌙 Лунная фаза | 50 | Влияние текущей фазы Луны |
| 🔢 Нумерология | 80 | Числовой анализ по дате рождения |
| 🧘 Чакры | 80 | Диагностика и рекомендации |
| 💞 Совместимость | 100 | Совместимость двух людей |
| 🕰️ Прошлые жизни | 120 | Регрессия и кармический анализ |
| 🪐 Натальная карта | 333 | Полная карта рождения с визуализацией |

### 👑 Премиум-подписка

Безлимитный доступ ко всем функциям без траты оракулов.
