/**
 * POST /api/profile — save personalization settings (display name + gender)
 *
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { initData, gender, displayName } = body;
    ...
    const updated = await db.user.update({
      ...
      select: { gender: true, displayName: true, firstName: true },
    });
