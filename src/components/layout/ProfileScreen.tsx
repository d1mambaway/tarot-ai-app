...
const T = {
  ...
  manaDesc: { ru: 'Мана тратится на расклады и чтения', uk: 'Мана витрачається на розклади та читання', en: 'Mana is spent on spreads and readings' },
  invite: { ru: 'Пригласи друга', uk: 'Запроси друга', en: 'Invite a friend' },
  inviteDesc: { ru: 'Получи 200 маны за каждого друга!', uk: 'Отримай 200 мани за кожного друга!', en: 'Get 200 mana per friend!' },
    ...
    <div className="px-4 pt-4 pb-4 relative z-10">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-4 gap-2">
          <div className="bg-mystic-bg/50 rounded-xl p-3 text-center">
            ...
            <p className="text-[10px] text-mystic-muted">{T.mana[l]}</p>
          </div>
          <div className="bg-mystic-bg/50 rounded-xl p-3 text-center">
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
        ...
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-sm font-bold text-mystic-text flex items-center gap-2"><ManaIcon size="md" /> {T.mana[l]}</h2>
        ...
        <p className="text-xs text-mystic-muted">{T.manaDesc[l]}</p>
      </motion.div>
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
        ...
        <p className="text-[11px] text-mystic-muted mb-3">{T.inviteDesc[l]}</p>
        <button onClick={() => {
