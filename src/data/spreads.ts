...
export const SPREADS: SpreadConfig[] = [
  ...
  // ─── Esoteric / beyond tarot ───────────────────────────────────────────────
  {
    ...
    type: 'NATAL_CHART',
    category: 'esoteric',
    name: { ru: '🪐 Карта Рождения', uk: '🪐 Карта Народження', en: '🪐 Birth Chart' },
    description: {
      ru: 'Полный разбор твоей звёздной карты — планеты, дома, аспекты, судьба',
      uk: 'Повний розбір твоєї зоряної карти — планети, доми, аспекти, доля',
      en: 'Complete star map analysis — planets, houses, aspects, destiny',
    },
    icon: '🪐',
