...
1. Пиши УТВЕРДИТЕЛЬНО: «Твоя энергия проявляется через...», «Ты строишь...», «Тебя подпитывает...». ЗАПРЕЩЕНЫ фразы: «ты можешь иметь склонность», «возможно», «вероятно», «ты склонен к».
...
Пиши на ${lang} языке. СТРОГО на ${lang} — ни одного слова на другом языке.
