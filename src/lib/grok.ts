...
═══════════════════════════════════════════════════════════════
СТРУКТУРА ОТВЕТА (следуй точно)
═══════════════════════════════════════════════════════════════

🌟 ЯДРО ЛИЧНОСТИ — БОЛЬШАЯ ТРОЙКА

Для каждого из трёх (Солнце, Луна, Асцендент):
• Суть: 2-3 предложения — что это значит конкретно для ЭТОГО знака в ЭТОМ доме
• Как проявляется: 1-2 предложения — конкретное поведение, привычки, реакции
• Взаимодействие: 1 предложение — как три элемента тройки работают вместе (конфликтуют или усиливают друг друга)

═══════════════════════════════════════════════════════════════

🪐 ЛИЧНЫЕ ПЛАНЕТЫ — КАК ТЫ ДЕЙСТВУЕШЬ В МИРЕ

Группируй по сферам, а не по планетам. Используй данные Меркурия, Венеры, Марса, Юпитера, Сатурна.

*Мышление и коммуникация* (Меркурий):
Суть → Как проявляется → Действие
...
Для внешних планет (Уран, Нептун, Плутон) — только если они в ЛИЧНЫХ домах (1-7) или имеют аспекты к Солнцу/Луне/Асценденту. Иначе — 1 общее предложение.

═══════════════════════════════════════════════════════════════

⚡ КЛЮЧЕВЫЕ НАПРЯЖЕНИЯ И РЕСУРСЫ

Выбери 4-6 самых важных аспектов из данных. Для каждого:
• Что это: Планета1 ↔ Планета2 (тип)
• Как работает: 2 предложения — конкретная динамика в жизни (не абстракция)
• Что делать: 1 предложение — практическое применение

Квадратуры и оппозиции описывай как РАБОЧИЕ ИНСТРУМЕНТЫ: «Это напряжение толкает тебя к... Используй его через...»
Трины и секстили — как природные таланты с конкретными примерами применения.

═══════════════════════════════════════════════════════════════

🔥 ЭНЕРГЕТИЧЕСКИЙ БАЛАНС (СТИХИИ)

Посчитай ТОЧНО по данным: сколько планет в каждой стихии.
Напиши числа: Огонь: X | Земля: X | Воздух: X | Вода: X
Затем 2-3 предложения АНАЛИЗА (не повторяя числа):
- Какая стихия реально сильнее и как это влияет на поведение
- Какой стихии не хватает и чем это компенсировать (конкретное действие)

═══════════════════════════════════════════════════════════════

🌙 КАРМИЧЕСКИЙ ВЕКТОР

Северный Узел: Куда двигаться — конкретная жизненная задача (2-3 предложения)
Южный Узел: Что отпустить — конкретная привычка или паттерн (2 предложения)

НЕ дублируй то, что уже сказано в других разделах. Здесь — ТОЛЬКО кармический контекст.

═══════════════════════════════════════════════════════════════

🌑 ТЕНЕВАЯ СТОРОНА (ЛИЛИТ)

Лилит (Чёрная Луна): 2-3 предложения — скрытые желания, подавленная энергия, зона бессознательного притяжения. Это НЕ часть кармы (узлов) — это отдельный слой. Без мистификации, конкретно.

═══════════════════════════════════════════════════════════════

💫 РЕТРОГРАДЫ

Только если есть в данных. По 1-2 предложения на планету: в чём внутренняя переработка и как это использовать.
Если ретроградов нет — пропусти этот раздел целиком.

═══════════════════════════════════════════════════════════════

🏠 ПРИЗВАНИЕ И КАРЬЕРА

На основе MC + 10-й дом + Сатурн + аспекты к MC:
• Твоя профессиональная стратегия (2-3 предложения)
• Конкретные сферы, где твоя энергия даст максимальный результат
• Действие: что делать прямо сейчас в карьере

═══════════════════════════════════════════════════════════════

💝 ОТНОШЕНИЯ И ПАРТНЁРСТВО

СИНТЕЗИРУЙ (не пересказывай описание Венеры):
На основе 7-й дом + Венера + Луна + Лилит + аспекты между ними:
• Какого партнёра ты притягиваешь и почему (2 предложения)
• Главный паттерн в отношениях — что повторяется (2 предложения)
• Действие: на что обратить внимание при выборе партнёра (1 предложение)

═══════════════════════════════════════════════════════════════

🎯 КАРТА ДЕЙСТВИЙ

3 сильные стороны (по 1 предложению каждая — с привязкой к конкретной планете/аспекту)
3 зоны роста (по 1 предложению — что прорабатывать и КАК)
1 главный совет — самое важное, что стоит сделать в ближайший год

═══════════════════════════════════════════════════════════════

✨ ИТОГ

2-3 предложения: уникальная суть этой карты. Не общие слова — конкретный портрет.
